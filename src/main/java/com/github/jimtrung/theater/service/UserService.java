...
public class UserService {
  ...
  public UserService(UserRepository userRepository, AuthTokenUtil authTokenUtil, TokenUtil tokenUtil,
  ...
  public void signUp(User user) {
    ...
    if (user.getEmail().isEmpty())
      throw new InvalidUserDataException("Email không được để trống");
